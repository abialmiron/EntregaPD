	...
	<div class="row justify-content-md-center align-items-center ">
		<div class="col-md-4">
			<div class="card shadow">
				...
				<div class="card-body">
					<form class="d-flex flex-column  needs-validation" novalidate method="GET" action="accionej5.php" id="form5" name="form5" required>
				<div class="row">
					<div class="col-md-8">
			...
			<label class="form-label">Edad:</label>
									<input type="text" name="edad" id="edad" class="form-control validate" maxlength="3" reuired>
									<div class="invalid-feedback">
					...
					<div class="row">
							<div class="col-md-5">
									...
									<input type="text" name="direccion" id="direccion" class="form-control validate" maxlength="30" required>
									<div class="invalid-feedback">

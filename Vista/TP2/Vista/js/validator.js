...
$(document).ready(function () {
  ...
  $(
    "#titulo,#actores,#director,#guion,#produccion,#nacionalidad,#floatingTextarea2"
  ).on("input", function () {
    var fieldValue = $(this).val().trim();
    if (fieldValue !== "") {
      $(this).removeClass("is-invalid");
  ...
  $("#form1").submit(function (e) {
    var isValid = true;
    $(
      "#titulo,#actores,#director,#guion,#produccion,#anio,#nacionalidad,#duracion,#floatingTextarea2"
    ).each(function () {
      var fieldValue = $(this).val().trim();
      if (fieldValue === "") {
        $(this).addClass("is-invalid");

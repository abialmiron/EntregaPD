...
<main class="p-5 text-center bg-light">
  <div class="justify-content-md-center align-items-center ">
    <div class="card shadow col-sm-8 col-md-6 col-lg-5 col-xl-4 mx-auto">
      ...
      <div class="card-body">
          <form class="needs-validation" novalidate method="get" action="accionBuscarAuto.php" name="form" id="form"  required>
              <div class="form-group row ">
                  <label class="text-start">Ingrese una patente:</label>
                  <div class="col-8">
                      <input type="text" class="form-control validate" id="patente" name="patente" required>
